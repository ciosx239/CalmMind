...
class MenuViewModel: ObservableObject {
    ...
    @Published var meditationCollection = [
        ...
        // MeditationModel(text: "Test Audio", image: .meditation, background: .orangeMain, time: 2, index: 5, audioURL: Bundle.main.url(forResource: "test", withExtension: "mp3")!, category: "Sleep")
    ]
